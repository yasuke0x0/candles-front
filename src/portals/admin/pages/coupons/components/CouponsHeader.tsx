                    ...
                    <div className="flex flex-col gap-4">
                         <div className="flex items-center justify-between gap-3">
                              ...
                              <div className="flex items-baseline gap-3">
                                   <h1 className="font-serif text-2xl text-stone-900 tracking-tight">Coupons</h1>
                                   {!isLoading && (
                              ...
                              <div className="flex items-center gap-2">
                                   ...
                                   <div className="hidden md:flex p-1 bg-stone-100 rounded-lg border border-stone-200 h-10 items-center mr-2">
                                        {(["ALL", "ACTIVE", "INACTIVE"] as const).map(status => (
                                             <button
                                                  ...
                                                  className={`px-4 h-full text-[10px] font-bold uppercase tracking-wider rounded-md transition-all flex items-center ${
                                                       statusFilter === status ? "bg-white text-stone-900 shadow-sm" : "text-stone-400 hover:text-stone-600"
                                                  }`}
                                             >
                                   ...
                                   >
                                        <Plus size={16} /> <span className="hidden sm:inline">New Coupon</span>
                                   </button>
                              </div>
                         </div>
                    </div>
