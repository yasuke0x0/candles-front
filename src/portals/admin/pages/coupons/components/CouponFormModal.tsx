                                   ...
                                   <div className="flex-1 overflow-y-auto p-8 space-y-8 scrollbar-thin">
                                        ...
                                        <div className="grid grid-cols-2 gap-6">
                                             <Field name="minOrderAmount">
                                                  {({ field, meta }: any) => (
                                                       <Input type="number" label="Min Order (€)" placeholder="0.00" {...field} error={meta.error} touched={meta.touched} />
                                                  )}
                                             </Field>
                                        ...
                                        <div className="grid grid-cols-2 gap-6 items-start">
                                             ...
                                             <div>
                                                  ...
                                                  >
                                                       <Field type="checkbox" name="isActive" className="w-4 h-4 text-green-600 rounded focus:ring-green-600 border-gray-300" />
                                                       <span className={`text-xs font-bold uppercase tracking-wider ${values.isActive ? "text-green-700" : "text-stone-500"}`}>
