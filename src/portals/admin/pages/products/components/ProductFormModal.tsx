...
const ProductFormModal = ({ isOpen, onClose, onSubmit, initialData, isSubmitting, onArchive }: ProductFormModalProps) => {
     ...
     const handleDiscountDelete = async (id: number, e: React.MouseEvent, setFieldValue: any, currentId: number | null) => {
          e.stopPropagation()
     ...
     const initialValues = {
          ...
          discountId: initialData?.discountId ?? initialData?.discount?.id ?? null,
     }
                                             ...
                                             <Form className="flex-1 flex flex-col overflow-hidden">
                                                                 ...
                                                                 {({ push, remove }) => (
                                                                      ...
                                                                      >
                                                                           ...
                                                                           <div className="flex flex-wrap gap-2">
                                                                                {values.scentNotes?.length === 0 && (
                                                                                     <span className="text-xs text-stone-400 italic">No notes added yet.</span>
                                                                                )}
                                                       ...
                                                       <div className="bg-stone-50 p-6 rounded-2xl border border-stone-200">
                                                            ...
                                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                                 {availableDiscounts.map(discount => {
                                                                      const isSelected = values.discountId === discount.id
                                                                      return (
                                                                           <div key={discount.id} className="relative group w-full">
                                                                                ...
                                                                                >
                                                                                     <div className="flex-1 min-w-0 mr-3">
                                                                                          <p
                                                                                               className={`font-bold text-xs truncate leading-relaxed ${isSelected ? "text-white" : "text-stone-900"}`}
                                                                                          >
                                                                                               {discount.name}
                                                                                          </p>
                                                                                     </div>
                                                                                     <div
                                                                                          className={`shrink-0 text-[10px] font-mono font-bold px-2 py-1 rounded-md border ${isSelected ? "bg-white/20 text-white border-transparent" : "bg-stone-100 text-stone-500 border-stone-200"}`}
                                                                                     >
                                                                                ...
                                                                                <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1 pl-2">
                                                                                     ...
                                                                                     <button
                                                                                          ...
                                                                                          className={`p-2 rounded-lg transition-all active:scale-90 ${isSelected ? "text-stone-300 hover:text-white hover:bg-white/20" : "text-stone-400 hover:text-stone-900 hover:bg-stone-100"}`}
                                                                                          title="Edit"
                                                                                     >
                                                                                          <Edit2 size={14} />
                                                                                     </button>
                                                                                     <button
                                                                                          type="button"
                                                                                          onClick={e => handleDiscountDelete(discount.id!, e, setFieldValue, values.discountId)}
                                                                                          className={`p-2 rounded-lg transition-all active:scale-90 ${isSelected ? "text-red-300 hover:text-red-200 hover:bg-red-900/50" : "text-stone-300 hover:text-red-600 hover:bg-red-50"}`}
                                                                                          title="Delete"
                                                                                     >
                                                                                          <Trash2 size={14} />
                                                                                     </button>
                                                  ...
                                                  <div className="px-8 py-6 border-t border-stone-100 bg-stone-50 flex justify-between items-center shrink-0">
                                                       ...
                                                       <button
                                                            ...
                                                            className="bg-stone-900 text-white rounded-xl font-bold text-sm uppercase tracking-wider hover:bg-stone-800 transition-all active:scale-[0.98] flex items-center justify-center gap-2 disabled:opacity-70 shadow-lg shadow-stone-900/10 h-[46px] w-[46px] sm:w-auto sm:px-8 sm:py-3"
                                                       >
                                                            {isSubmitting ? (
                                                                 <Loader2 className="animate-spin" size={18} />
                                                            ) : (
                                                                 <>
                                                                      <Save size={18} /> <span className="hidden sm:inline">Save Product</span>
                                                                 </>
                                                            )}
                                                       </button>
                                                  </div>
