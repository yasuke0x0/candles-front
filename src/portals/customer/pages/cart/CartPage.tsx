...
const CartPage = () => {
     ...
     const { cartItems: items, setCartItems } = useContext(CustomerPortalContext)
                                                  ...
                                                  <div className="flex-grow flex flex-col justify-between py-1">
                                                       <div className="flex justify-between items-start">
                                                            ...
                                                            <div className="text-right">
                                                                 ...
                                                                 {isDiscounted && (
                                                                      <span className="text-sm text-stone-400 line-through block">${(item.price * item.quantity).toFixed(2)}</span>
                                                                 )}
                                                            </div>
                                                       </div>
