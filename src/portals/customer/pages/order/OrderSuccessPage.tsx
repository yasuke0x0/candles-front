...
import { CART_STORAGE_KEY, CHECKOUT_FORM_STORAGE_KEY } from "@portals/customer/constants.ts"
import { CustomerPortalContext } from "@portals/customer/CustomerPortal"

const OrderSuccessPage = () => {
     const [status, setStatus] = useState<"loading" | "success" | "error">("loading")
     const [searchParams] = useSearchParams()
     const navigate = useNavigate()
     const { setCartItems, setCoupon } = useContext(CustomerPortalContext)
